...
def mirror_hsi(height, width, band, input, patch):
    ...
    mirror_hsi[padding : (padding + height), padding : (padding + width), :] = input

    for i in range(padding):
        mirror_hsi[padding : (height + padding), i, :] = input[:, padding - i - 1, :]

    for i in range(padding):
        mirror_hsi[padding : (height + padding), width + padding + i, :] = input[
            :, width - 1 - i, :
        ]
